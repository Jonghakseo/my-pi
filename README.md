...
The current setup has 11 agent definitions, three model families, and one main agent:
...
- **ollama-cloud/glm-5.1:cloud** — Enabled local/cloud provider option for specialized local extension experiments
...
| [`ollama-glm-5-1-cloud/`](./extensions/ollama-glm-5-1-cloud/index.ts) | Ollama Cloud provider wiring for GLM 5.1 |
...
| [`archive-to-html/`](./extensions/archive-to-html/index.ts) | Archives HTML generated by the `to-html` skill or widget output into `~/Documents` |
