...
function configuredThemeFromSettings(): string | null {
	try {
		...
		// Ignore missing/invalid settings and fall back to theme map.
	}
	return null;
}
...
/**
 * No-op extension factory so this utility file can be auto-loaded safely.
 * (Pi expects every file in ~/.pi/agent/extensions to export a default factory.)
 */
export default function themeMapExtension(_pi: ExtensionAPI): void {
	// Intentionally empty.
}
