...
| `@ryan_nookpi/pi-extension-auto-name` | Auto-detect session names from the first user message |
| `@ryan_nookpi/pi-extension-delayed-action` | Schedule deferred actions |
| `@ryan_nookpi/pi-extension-idle-screensaver` | Idle terminal screensaver |
| `@ryan_nookpi/pi-extension-todo-write` | `todo_write` tool with persistent TUI task management |
