...
export const SUBVIEW_OVERLAY_WIDTH = "90%";
export const SUBVIEW_OVERLAY_MAX_HEIGHT = "80%";
...
export const TOOL_CALL_ARGS_SUMMARY_MAX_CHARS = 120;
export const TOOL_RESULT_DETAILS_SUMMARY_MAX_CHARS = 300;
export const REPLAY_CONTENT_MAX_CHARS = 1_000;
...
export const LIST_HEIGHT_RATIO = 0.4;
...
export const PREVIEW_WIDTH_DIVISOR = 2;
