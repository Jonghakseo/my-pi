...
vi.mock("./overlay-component.js", () => ({
	InteractiveShellOverlay: class {},
}));

vi.mock("./reattach-overlay.js", () => ({
...
vi.mock("./runtime-coordinator.js", () => ({
