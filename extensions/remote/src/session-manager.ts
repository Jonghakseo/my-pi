...
// biome-ignore lint/complexity/useRegexLiterals: regex literal form triggers noControlCharactersInRegex for the required OSC title-sequence escapes.
const TITLE_REGEX = new RegExp("\\x1b\\]0;(.*?)(\\x07|\\x1b\\\\)", "g");
