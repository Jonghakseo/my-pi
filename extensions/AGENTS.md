...
├── output-compactor/      # Compress >24KB bash output via GPT-5.6 Luna; save original to tmp, inject summary+path; footer shows net tokens saved (re-reading the tmp original flips that entry negative)
