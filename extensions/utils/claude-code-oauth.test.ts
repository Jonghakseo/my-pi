...
import piClaudeCodeUse, { _test } from "../claude-code-oauth/index.js";
...
// biome-ignore lint/complexity/noExcessiveLinesPerFunction: single top-level describe from upstream test suite; splitting loses shared beforeEach and helper scope.
